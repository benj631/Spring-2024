...
```{r}
pairs(zachdata,panel=panel.smooth, col=as.factor(data$x2))
pairs(zachdata,panel=panel.smooth, col=as.factor(data$x4))
```
...
ggplot(zachdata, aes(x=x1+x5+x6,y=y,col=interaction(x2,x3))) +
  geom_point() +
