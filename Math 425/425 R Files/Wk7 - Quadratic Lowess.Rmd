---
title: "Quadratic Lowess"
output: html_document
date: "2024-06-03"
---

``` {r}
# Lowess, not loess, because QUADRATIC
...
for (xc in 1:n){ #let each dot be the center dot, one at a time
  ...
  plot(Y ~ X + I(), pch=21, bg=rgb(.53,.81,.92, w), #color dots by their weights
       col=rgb(.2,.2,.2,.3), cex=1.5, yaxt='n', xaxt='n', xlab="", ylab="")
  points(Y[xc] ~ X[xc] + I(X[xc]^2), pch=16, col="orange") #add center dot to plot
